...
execute as @s at @s run summon minecraft:armor_stand ~ ~ ~ {Tags:["dhcflpT"],Invisible:1b,Invulnerable:1b,Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:magma_block"},Time:-24000,DropItem:0b}]}
